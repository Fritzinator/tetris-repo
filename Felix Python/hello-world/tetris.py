...
def draw_next_shape(shape, surface):
    ...
    label = font.render('Nächste Form:', 1, (255, 255, 255))
    ...
    for i, line in enumerate(shape_format):
        ...
        for j, column in enumerate(row):
            if column == '0':
                pygame.draw.rect(surface, shape.color,) (sx + j * BLOCK_SIZE, sy + i * BLOCK_SIZE, BLOCK_SIZE,)
...
def draw_next_shape(shape, surface):
    ...
    for i, line in enumerate(shape_format):
        ...
        for j, column in enumerate(row):
            if column == '0':
              (pygame.draw.rect(surface, shape.color,) sx + j * BLOCK_SIZE, sy + i *)
